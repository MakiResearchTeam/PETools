...
def compute_cuboid_diag(p1, p2, diag3d_length, p1_closer):
    """
    ...
    z = math.sqrt(diff if diff > 0.0 else 0.0)
...
def compute_angle_2vec(p1, p2, p3, p1p2_dist, p2p3_dist):
    """
...
def compute_angle_1vec(p1, p2, p1p2_dist):
    """
    Computes angle between vectors p2-p1 and p2-p3.
    It also computes angle between p2-p3 vector and [0, 1, 0] vector (normal vector pointing down).
    ...
    -------
    float, float
        Angle between vectors p2-p1 and p2-p3 and an angle between vector p2-p3 and a normal [0, 1, 0] (normal vector
        points down).
    """
...
def angle2vecs(points2d, points3d, points_keys, limb_lengths, limb_lengths_keys):
    ...
    return compute_angle_2vec(p2, p1, p3, p2p1_dist, p2p3_dist)
...
def angle1vec(points2d, points3d, points_keys, limb_lengths, limb_lengths_key):
    ...
    return compute_angle_1vec(p2, p1, p2p1_dist)


def right_shoulder_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def left_shoulder_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def right_hip_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def left_hip_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def right_shoulder_normal_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def left_shoulder_normal_angle(points2d, points3d, limb_lengths, pose_name=None):
    # Right shoulder, right elbow
    point_keys = ['p4', 'p6']
    lengths_key = 'se'
    return angle1vec(points2d, points3d, point_keys, limb_lengths, lengths_key)
...
def right_hip_normal_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def left_hip_normal_angle(points2d, points3d, limb_lengths, pose_name=None):
    # Left hip, left knee
    point_keys = ['p10', 'p12']
    lengths_key = 'hk'
    return angle1vec(points2d, points3d, point_keys, limb_lengths, lengths_key)
...
def right_elbow_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def left_elbow_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def right_knee_angle(points2d, points3d, limb_lengths, pose_name=None):
...
def left_knee_angle(points2d, points3d, limb_lengths, pose_name=None):
