...
class Postprocess3DPCANoFingers(DataProcessor):
    ...
    def __call__(self, transformed_data: np.ndarray, source_human: Human, **kwargs):
        # Denorm data from PCA-space
        coords3d = self.human_processor.denorm3d_pca(transformed_data)
        # Add additional points - fingers as zeros
        ...
        # Zero additional points
        coords3d[[3, 7, 15, 16, 20, 21]] = 0.0
        # Map skelet to prod format
        ...
        # Set 3d points to human class and return it
